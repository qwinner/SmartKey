...
public class UpdateApp {
    ...
    private Handler mHandler = new Handler() {
    	public void handleMessage(Message msg) {
    	    ...
    	    case DOWN_NOSDCARD:
        		downloadDialog.dismiss();
        		Toast.makeText(mContext, "�޷����ذ�װ�ļ�������SD���Ƿ����",Toast.LENGTH_SHORT).show();
        		break;
    	    case DOWN_ERROR:
        		downloadDialog.dismiss();
        		if(msg.arg1==0){
        			Toast.makeText(mContext, "���粻������", Toast.LENGTH_SHORT).show();
        		}else if(msg.arg1==1||msg.arg1==2){
        			Toast.makeText(mContext, "δ�ҵ���Դ",Toast.LENGTH_SHORT).show();
        		}
        		break;
    	    }
    	};
    	...
    	new Thread() {
    		public void run() {
    			...
    			try {
    				...
    				HttpGet get = new HttpGet(ActivityList.getInstance().UpdateUrl);
