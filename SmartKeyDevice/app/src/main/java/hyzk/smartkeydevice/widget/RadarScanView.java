...
public class RadarScanView extends View
{
    ...
    private int circleColor = Color.parseColor("#FFFAFA");
    private int radarColor = Color.parseColor("#99a2a2a2");
    private int tailColor = Color.parseColor("#FFFF7A");
...
//            Shader shader = new SweepGradient(centerX, centerY, Color.parseColor("#FFCC33"),
